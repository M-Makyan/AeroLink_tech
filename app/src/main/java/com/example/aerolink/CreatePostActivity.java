...
public class CreatePostActivity extends AppCompatActivity {
    ...
    private void uploadImageToFirebase(String title,
                                       String description,
                                       Uri imageUri) {
                        ...
                        storageRef.getDownloadUrl()
                                ...
                                .addOnFailureListener(e -> {
                                    ...
                                    Toast.makeText(CreatePostActivity.this,
                                            "Failed to fetch image URL: " + e.getMessage(),
                                            Toast.LENGTH_SHORT).show();
                                })
                )
                .addOnFailureListener(e -> {
    ...
    private void savePostToFirestore(String title,
                                     String description,
                                     String imageUrl) {
        // get the signed-in user
        FirebaseUser me = FirebaseAuth.getInstance().getCurrentUser();
        String username = (me != null && me.getDisplayName() != null)
                ? me.getDisplayName()
                : "Unknown";
        ...
        firestore.collection("posts")
                ...
                .addOnFailureListener(e -> {
                    ...
                    uploadImageButton.setEnabled(true);
                    Toast.makeText(CreatePostActivity.this,
                            "Failed to upload post: " + e.getMessage(),
